...
3. 只提取与校园活动、讲座、志愿招募、电影放映、重要通知相关的信息
4. 以下内容【不要提取】：安全提醒、防诈骗宣传、广告、与校园活动无关的内容
5. 输出必须是 JSON 数组，即使只有一个活动

输出格式：
[
  {
    "category": "lecture | event | volunteer | movie | notice",
    "title": "活动名称",
    "organizer": "主办方/组织",
...
- movie: 电影放映、影片放映、观影活动、影片排片
- notice: 重要通知（选课、考试、缴费、场馆开放/闭馆、放假安排、比赛报名等）
